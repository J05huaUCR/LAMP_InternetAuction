...
$session_vars['id'] = fNewId($trace); // Changes
...
if ($session_vars['platform'] != "dc") { // ZeroClick
	...
	if ($trace == 2) {
		...
		echo "ZCZCZCZCZCZCZCZCZCZCZCZCZCZCZCZCZCZCZCZCZCZCZCZCZCZCZCZCZCZCZCZCZCZCZCZCZCZCZCZC<br /><br />";
	}
	...
	* ==========================================================================================*/
	...
	fWriteSessionTime($MYSQL_CONNECTION, $start, $date, &$session_vars, $trace); // Write Back Session Time
	...
	if ($trace > 1) { echo "No winner for ZeroClick going to DirectClick.<br />"; }/* TRACE OUTPUT */
...
if ($session_vars['platform'] == "dc") { // DirectClick
	...
	if ($trace > 1) {
		...
		echo "Time to MULTI-PROGRAMMING SECTION: " . fMarkTime($start) . "<br />";
		echo "DCDCDCDCDCDCDCDCDCDCDCDCDCDCCDCDCDCDCDCDCDCDCDCDCDCDCDCDC<br /><br />";
	}

	fInsert_Assoc_Array($MYSQL_CONNECTION, &$session_vars, $table, $date, $trace); // Write Session Data to db
	if ($trace == 2) { echo "TESTING IN DC.<br />"; }/* TRACE OUTPUT */
	/*==========================================================================================
	* BEGIN MULTI-PROGRAMMING SECTION
	* ==========================================================================================*/
	$FEEDS = array(); // unset array
