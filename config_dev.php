...
// db Tables 20120319
$TRACKING_DB_NAME = "";
$TABLE_PLATFORM_PREFIX = "TEST_"; // Change to "DC_" when testing is done
$TABLE_SESSION_POSTFIX = "_sessions";
$TABLE_BIDS_POSTFIX = "_bids";
$TABLE_IP_LOCATIONS = "IP_Table";
$TABLE_IP_BLACKLIST = "ip_blacklist";
$TABLE_DOMAIN_KEYWORDS = "keywords_by_domain";
$TABLE_KEYWORDS = "keywords_related";
...
// Constants
$KEYWORDS_INDEX = 192700; // totoal number of keywords
$DOMAINS_INDEX = 132553; 
